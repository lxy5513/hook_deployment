...
class Inferer:
    def __init__(self, source, weights, device, img_size, half):
        ...
        self.class_names = ['install', 'uninstall', 'box'] 
    ...
    def infer(self, conf_thres, iou_thres, classes, agnostic_nms, max_det, save_dir, save_txt, save_img, hide_labels, hide_conf, view_img=True):
        ...
        for img_src, img_path, vid_cap in tqdm(self.files):
            ...
            # print("conf thres: {}\tiou thres: {}".format(conf_thres, iou_thres))
            ...
            if save_img:
                if self.files.type == 'image':
                    img_src = cv2.resize(img_src, (960, 480))
